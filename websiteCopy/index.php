...
<div class="container">
    ...
    <img src="images/logos/headerlogo.jpg" id="cards" class="img-responsive pull-left" alt="">
    <br>
...
<div class="container">
    ...
    <div class="media">
        ...
        <div class="media-body">
            <h3 class="media-heading">Mens clothes that'll keep you outta jail</h3>
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
            <a href="tshirts.php" class="btn btn-default btn-lg" role="button">Shop Now</a>
        ...
        <div class="media-right media-bottom">
            <a href="#">
                <img class="media-object" src="images/logos/header3.jpg" alt="..."  width="500" length="300">
            </a>
        </div>
    </div>
</div>
...
<div class="container">
    ...
    <div class="media"> <!-- class media , to create media element-->
        <a class="pull-left" href="#">
            <img class="media-object" src="images/logos/header2.jpg" alt="..." width="250" length="150">
        </a>
        <div class="media-body">
            <h3 class="media-heading">l33t Fashion for the Fall</h3>
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
            <a href="tshirts.php" class="btn btn-default btn-lg" role="button">Shop Now</a>
        </div>
    </div>
...
<div class="modal fade clickable" id="modalRegister" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    ...
    <script>
        function loadRegister(){
            ...
            var fname = document.getElementById("txtLname");
            var fname = document.getElementById("txtEmail");
            var fname = document.getElementById("txtPass");
            ...
            xmlhttp.open("POST",rootDir + "/php/register.php?fname="+fname+"&lname="+lname+"&email="+email+"&location="+loc+"&password="+pass,true);
            xmlhttp.send();
        }
    </script>
