    ...
    if (!empty($product_array)) {
        foreach($product_array as $key=>$value){
            ...
            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                <form method="post" action="mensshirts.php?action=add&code=<?php echo $product_array[$key]["code"]; ?>">
        ...
        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
            <div class="thumbnail">
                ...
                <div class="caption">
                    ...
                    <p>$45.oo</p>
                    <p><a href="productpage.html" class="btn btn-primary" role="button">Add to Cart</a></p>
                </div>
            </div>
        </div>
        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
