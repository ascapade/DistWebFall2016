...
<div class="container">
        <div class="page-header">
            <h1><Strong>Put sex here</Strong></h1>
        </div>
        </div>
...
<!-- Media object -->
            ...
            <div class="media-left media-top">
                <a href="#">
                <img class="media-object img-rounded" src="picMwhiteT.jpg" alt="..."  width="500" length="300">
                </a>
            </div>
            <div class="media-body">
                ...
                <a href="productpage.html" class="btn btn-primary" role="button">Add to Cart</a>
